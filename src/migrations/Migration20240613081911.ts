...
export class Migration20240613081911 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "comment" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz null, "meta" jsonb null, "content" varchar(255) not null, "author_id" varchar(255) not null, "parent_comment_id" varchar(255) null, "organization_id" varchar(255) null, "entity_context_id" varchar(255) not null, "status" varchar(255) not null default \'published\', "is_reported" boolean not null default false, constraint "comment_pkey" primary key ("id"));');
    ...
    this.addSql('create table "comment_report" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz null, "meta" jsonb null, "author_id" varchar(255) not null, "comment_id" varchar(255) not null, "reason" varchar(255) not null, "status" varchar(255) not null default \'new\', "category" varchar(255) null, "internal_note" varchar(255) null, constraint "comment_report_pkey" primary key ("id"));');
